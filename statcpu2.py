...
def main(directory):
    ...
    outSummaryFile.write("DBName;Instance;AVG CPU;CPU P95;CPU Max;DB CPU Max;DB CPU P95; \
        Read IOPS Mean;Write IOPS Mean;Read MBPS Mean;Write MBPS Mean; \
        Redo Log MBPS;Mean Sessions\n")
...
#            outString = outString + formatter(os_cpu_max.mean()) + ";" + formatter(os_cpu_max.max()) + ";"
            ...
            outString = outString + formatter(read_iops_max.mean()) + ";" + formatter(write_iops_max.mean()) + ";"
            outString = outString + formatter(read_mb_s_max.mean()) + ";" + formatter(write_mb_s_max.mean()) + ";"
            outString = outString + formatter(redo_mb_s.mean()) + ";" + formatter(max_sessions.mean()) + "\n"
            print(outString)
