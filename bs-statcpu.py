...
def main(directory):
    ...
    outSummaryFile = open(reports + 'resumo-databases-' + 'seguros' + '.csv', 'w+')
    outSummaryFile.write("DBName;Instance;AVG CPU;CPU P95;CPU Max;DB CPU; \
...
#        print("instance " + str(instance))
    ...
    for dbname in summaryData:
        ...
        for instance in range(1,(number_of_instances[dbname] + 1)):
            ...
            plotHistogram(os_cpu_max, histMainPath + "/cpu-max-" + tittle, tittle, "amostra", "% CPU máxima")
            ...
            plotHistogram(db_cpu, histMainPath + "/db-cpu-" + tittle, tittle, "amostra", "% DB CPU")
            ...
            plotHistogram(read_mb_s_max, histMainPath + "/read-MB-max-" + tittle, tittle, "amostra", "Read MB máximo")
            ...
            plotHistogram(read_iops_max, histMainPath + "/read-IOPS-max-" + tittle, tittle, "amostra", "Read IOPS máximo")
            ...
            plotHistogram(write_mb_s_max, histMainPath + "/write-MB-max-" + tittle, tittle, "amostra", "Write MB máximo")
            ...
            plotHistogram(write_iops_max, histMainPath + "/write-IOPS-max-" + tittle, tittle, "amostra", "Write IOPS máximo")
            ...
            plotHistogram(redo_mb_s, histMainPath + "/REDO-MB-per-sec-" + tittle, tittle, "amostra", "REDO MB/s")
            ...
            plotHistogram(max_sessions, histMainPath + "/Max-Sessions-" + tittle, tittle, "amostra", "Max Sessions")
