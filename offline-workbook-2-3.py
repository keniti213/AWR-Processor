...
def main(directory, context):
    ...
    outSummaryFile.write("DBName;Instance;AVG CPU;CPU P95;CPU Max;DB CPU Max; \
        DB CPU P" + str(context['DEFAULT_PERCENTILE']*100) + "; \
...
#        print("instance " + str(instance))
    ...
    for dbname in main_metrics:
        ...
        for instance in range(0, (number_of_instances[dbname])):
            ...
            print(" processing instance : ", instance_number)
            data_of_instance.to_csv(reports + dbname + "-main-metrics.csv")
            print("     writing main-metrics to file : ", reports + dbname + "-instance-" + str(instance_number) + "-main-metrics.csv" )
...
#            outString = outString + formatter(os_cpu_max.mean()) + ";" + formatter(os_cpu_max.max()) + ";"
            ...
            print("     plotted graphs in directory ", graphDir)
            print("     plotted histograms in directory ", histDir)
            outSummaryFile.write(outString)
            print("     summary line for instance " + str(instance_number) + 
            ...
            server_model = ''
            chip_count = number_of_sockets[dbname] if number_of_sockets[dbname] != '' else 0
    ...
    writer.save()
    print("\nCreated " + reports + output_excel_file + "-" + date_time_now + ".xlsx" + " successfully")
...
if __name__ == "__main__":
    ...
    DEFAULT_PERCENTILE = _context['DEFAULT_PERCENTILE']
    DEFAULT_ANNUAL_GROWTH = _context['DEFAULT_ANNUAL_GROWTH']
    REDO_LOG_RATE = _context['REDO_LOG_RATE']
    output_excel_file = _context['output_excel_file']
    ...
    if (len(sys.argv) == 2) and os.path.exists(dirname + os.sep + sys.argv[1]):
        ...
        print("invalid arguments: Offline-Workbook-2-3 <input files directory>\n")
        sys.exit()